...
/**
 * Vcenter logic message
 *
 */
public class VCenterViewModel {
	// base
	String uuid;
	String id ;//vcid
	String description_name;// 描述名称
	Integer cluster_count;// 集群数量
	Integer host_count;// 主机总数,物理机总数
	Integer vm_count;// 虚拟机总数
	// CPU
	Integer cpu_core_count;// cpu总核心数
	Integer vcpu_core_count;// vcpu总核心数
	Double cpu_used_scale;// cpu平均使用率

	Double cpu_portion_scale;// cpu core 分配比 ：由vcpu_core_count/cpu_core_count得出
	// Memory
	...
	public String toString() {
		return "VCenterViewModel [id=" + id + ", description_name="
				+ description_name + ", cluster_count=" + cluster_count
	...
	public Integer getCluster_count() {
		return cluster_count;
	}

	public void setCluster_count(Integer cluster_count) {
	...
	public void setVstore_cap(Double vstroe_cap) {
		this.vstore_cap = vstroe_cap;
	}
